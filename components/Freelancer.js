...
const Freelancer=({username,description,youDo,skills,slug})=>{
    
    return(
      
        <div className='w-full  md:w-[60vw] lg:w-[50vw] p-2 md:p-10 shadow-md mx-auto border-2 rounded-md border-orange-300 mt-5'>

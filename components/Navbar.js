          ...
          <div className="  flex items-center justify-between h-16 ">
            <div className="   flex items-center sm:hidden">
              {/* Mobile menu button*/}
                ...
                <div className="ml-2" onClick={()=>mobileMenu?setMobileMenu(false):setMobileMenu(true)}>
            <div className="flex flex-col md:hidden  " onClick={()=>hamburgerMenu?setHamburgrMenu(false):setHamburgrMenu(true) }>
            <span className={`h-[3px] w-[26px] my-[3px] bg-black origin-top-left   transition ` +(hamburgerMenu?'rotate-45':'rotate-0') }></span>
            <span className={`h-[3px] w-[26px] my-[3px] bg-black transition `+(hamburgerMenu?'opacity-0':'opacity-1')}></span>
            <span className={`h-[3px] w-[26px] my-[3px] bg-black origin-bottom-left  transition ` +(hamburgerMenu?'-rotate-45':'rotate-0') }></span>
                </div>
                </div>

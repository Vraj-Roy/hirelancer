...
const Signup = ({ resetkey }) => {
  ...
  const [responsedMessage, setResponsedMessage] = useState("");
  ...
  return (
    <>
      ...
      <div>
        <div
          className={`main-bg w-full h-[90vh] overflow-hidden flex  items-center justify-center `}
        >
              ...
              <div className="w-full mb-2">
                <div className="flex items-center">
                  ...
                  <input
                    ...
                    className={
                      "w-full border rounded px-4 py-2   focus:outline-orange-500 "
                    }
                  />
                </div>
              </div>
              ...
              <div className="w-full mb-2">
                <div className="flex items-center">
                  ...
                  <input
                    ...
                    className={
                      "w-full border rounded px-4 py-2   focus:outline-orange-50 "
                    }
                  />
                </div>
              </div>
